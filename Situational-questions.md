...
* Посмотреть был ли доступен сервер\сервис в момент создания статьи;
...
* Проверить работу бэка по обработке данных запроса;
...
* Проверить работу бэка по передаче данных на фронт;
* Проверить работу фронта по отображению информации;
* Проверить функционал, имитируя различную скорость интернет соединения и потерю части пакетов.
...
* Посмотреть права доступа пользователя;
...
* Проверить был ли недоступен сервер\сервис;
* Посмотреть информацию о пользователей в БД;
* Посмотреть информацию о транзакции в БД;
* Посмотреть логи сервера;
* Посмотреть актуальность версии клиентского приложения;
* Посмотреть права доступа пользователя;
* Пройтись по пользовательскому флоу;
...
* Получить информацию о количестве случаев сбоя работы данного функционала;
* Проверить был ли недоступен сервер\сервис;
* Посмотреть актуальность версии клиентского приложения (в зависимости от версии месенджера);
* В зависимости от архитектуры приложения проверить логи;
* Проверить информацию в БД;
* Пройтись по пользовательскому флоу;
* Проверить содержание запросов, ответов;
* Проверить работу фронта по формированию запроса на сервер;
...
* Проверить работу бэка по обработке данных из БД;
* Проверить работу бэка по передаче данных на фронт;
* Проверить отображение сообщений, имитируя различную скорость интернет соединения и потерю части пакетов;
* Проверить работу фронта по отображению информации.
...
* Посмотреть логи сервера;
* Посмотреть информацию о пользователей в БД;
* Пройтись по пользовательскому флоу с Валидными данными;
* Проверить содержание запросов, ответов при время регистрации;
* Проверить работу фронта по формированию запроса на сервер при время регистрации;
* Проверить работу бэка по обработке данных запроса при регистрации;
* Проверить работу бэка по записи данных в БД при регистрации;
* Проверить информацию в БД после регистрации;
* Проверить содержание запросов, ответов при авторизации;
* Проверить работу фронта по формированию запроса на сервер при авторизации;
* Проверить работу бэка по обработке данных запроса при авторизации;
* Проверить работу бэка по чтению данных из БД при авторизации;
* Проверить работу бэка по обработке данных из БД при авторизации;
* Проверить работу бэка по передаче данных на фронт при авторизации;
* Проверить работу фронта по отображению информации;
* Проверить работу функционала, имитируя различную скорость интернет соединения и потерю части пакетов.
